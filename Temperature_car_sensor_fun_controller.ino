...
float dt_window = 5;      // Delta temp for each temp reading. Validate sensor data to avoid connection issues
...
int fan_1_pwm_pin = 5;             // D5
int fan_2_pwm_pin = 6;             // D6
int ledPin = 13;                   // Arduino LED

// Output Levels for FAN PWM
int fan_1_speed_factor = 5;
int fan_1_pwm_speed_1 = 40;
int fan_1_pwm_speed_2 = 255;
int fan_2_speed_factor = 50;   // ms
int fan_2_pwm_speed_1 = 50;
int fan_2_pwm_speed_2 = 255;
